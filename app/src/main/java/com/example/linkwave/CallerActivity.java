...
public class CallerActivity extends Activity implements
    ...
    private String mRoomPin; // Used for VidyoCloud systems, not Vidyo.
    private Button shareRoom;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shareRoom = (Button) findViewById(R.id.ShareCallid);
        ...
        shareRoom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String resourceId = mResourceId.getText().toString().trim();
                shareRoom(resourceId);
            }
        });
    ...
    void shareRoom(String room){
        Intent sharingIntent = new Intent(android.content.Intent.ACTION_SEND);
        sharingIntent.setType("text/plain");
        String shareBody = room;
    ...
    public void onBackPressed() {
        if (checkConnect){
            Toast.makeText(CallerActivity.this,"Please disconnect first! ",Toast.LENGTH_SHORT).show();
        }
        else {
            super.onBackPressed();
    ...
    protected void onStart() {
        ...
        if (mRefreshSettings &&
            ...
            //String tok =  generateProvisionToken("c531146fca4f4a5db29dbe7652e0624d", "381ebb.vidyo.io", "9999", "");

            //Log.i("Video_IO_CALL_TOK",tok);
            ...
            if (uri != null) {
                ...
                mToken.setText("cHJvdmlzaW9uAHVzZXJyQDM4MWViYi52aWR5by5pbwA3MzcyODY4NjM1MgAAZGYyMjFkODg2YjYzYzM5NDYzYjBmOGNmYjE4YjM1M2MzMTQzOTc0ZDYyYjE5MzIwNjdjOWU4MjkzNjkyODU5ZTc3YjMxOWQ0NDRkNWFkMmMwNDFmMjg3ZjZhMjY1MjMx");
